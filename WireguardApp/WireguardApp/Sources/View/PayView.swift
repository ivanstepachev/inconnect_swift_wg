...
class PayView: UIView {
    ...
    let tableView: UITableView = {
        let tableView = UITableView()
        tableView.register(PayTableHeader.self, forHeaderFooterViewReuseIdentifier: PayTableHeader.identifier)
        tableView.register(PayTableFooter.self, forHeaderFooterViewReuseIdentifier: PayTableFooter.identifier)
        tableView.register(PayTableCell.self, forCellReuseIdentifier: PayTableCell.identifier)
        tableView.register(PayTableCell2.self, forCellReuseIdentifier: PayTableCell2.identifier)
