...
extension TunnelConfiguration {
    ...
    convenience init(fromUapiConfig uapiConfig: String, basedOn base: TunnelConfiguration? = nil) throws {
        ...
        for line in lines {
            ...
            let peerSectionKeys1: Set<String> = ["public_key", "preshared_key", "allowed_ip", "endpoint", "persistent_keepalive_interval", "last_handshake_time_sec"]
            let peerSectionKeys2 = ["last_handshake_time_nsec", "rx_bytes", "tx_bytes", "protocol_version"]
            let peerSectionKeys = peerSectionKeys1 + peerSectionKeys2
